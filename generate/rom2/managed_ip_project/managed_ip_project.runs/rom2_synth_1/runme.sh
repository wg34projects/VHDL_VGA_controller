...
HD_PWD='/home/helmutresch/WorkDir/VHDL_VGA_controller/generate/rom2/managed_ip_project/managed_ip_project.runs/rom2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom2.vds -m64 -mode batch -messageDb vivado.pb -notrace -source rom2.tcl
