...
HD_PWD='/home/helmutresch/WorkDir/VHDL_VGA_controller/impl/VGA_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_VGA.vds -m64 -mode batch -messageDb vivado.pb -notrace -source top_VGA.tcl
