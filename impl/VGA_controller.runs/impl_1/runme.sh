...
HD_PWD='/home/helmutresch/WorkDir/VHDL_VGA_controller/impl/VGA_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_VGA.vdi -applog -m64 -messageDb vivado.pb -mode batch -source top_VGA.tcl -notrace
