...
add wave -noupdate -height 30 -format Unsigned /tb_vgacontroller/pixelhorizontal_o
add wave -noupdate -height 30 -format Unsigned /tb_vgacontroller/pixelvertical_o
