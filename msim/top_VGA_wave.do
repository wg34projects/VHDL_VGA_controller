...
add wave -divider -height 30 "OUTPUT"
add wave -noupdate -height 30 -format Logic /tb_top_VGA/red_o
add wave -noupdate -height 30 -format Logic /tb_top_VGA/green_o
add wave -noupdate -height 30 -format Logic /tb_top_VGA/blue_o
add wave -noupdate -height 30 -format Logic /tb_top_VGA/h_sync
add wave -noupdate -height 30 -format Logic /tb_top_VGA/v_sync

add wave -divider -height 30 "INTERNALS"
add wave -noupdate -height 30 -format Logic /tb_top_VGA/i_top_VGA/swsync
add wave -noupdate -height 30 -format Logic /tb_top_VGA/i_top_VGA/pbssync
